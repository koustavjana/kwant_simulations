...
syst, leads, dum_lead = mlg.make_system(W = W, L = L, delta = delta, t = t)

def family_colors(site):
	return 0 if (site.family == mlg.a) else 1
...
band_data = np.zeros((num_momenta,1+int(W*4/sqrt(3))))
band_data[:,0] = momenta
band_data[:,1:] = plot_bandstructure(dum_lead.finalized(), momenta)
