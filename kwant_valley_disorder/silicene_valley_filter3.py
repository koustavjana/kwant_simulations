...
#np.savetxt('/home/bmlabserver05/Koustav/figures_csv/silicene_band_d20.csv',band_data,delimiter=',')
...
def compute_T(smatrix) :     
	...
	for i in range(smatrix.num_propagating(0)) :
		for j in range(smatrix.num_propagating(1)) :
...
np.savetxt('/home/bmlabserver05/Koustav/topo_fig_commit7/W_100_10.csv',valley_trans_data,delimiter=',') 
